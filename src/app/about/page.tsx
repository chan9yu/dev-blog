	...
	return (
		<div className="mx-auto">
			<article className="prose prose-lg">
				...
				{/* Content */}
				<div className="space-y-8" style={{ color: "rgb(var(--color-text-secondary))" }}>
					<section>
					...
					<section>
						...
						<div className="space-y-4 leading-relaxed">
							<div>
								<h3 className="mb-2 font-semibold" style={{ color: "rgb(var(--color-text-primary))" }}>
									주로 사용하는 기술
								</h3>
					...
					<section>
						...
						<p className="leading-relaxed">
							...
							이메일:{" "}
							<a
								href="mailto:dev.cgyeo@gmail.com"
								className="font-medium underline"
								style={{ color: "rgb(var(--color-accent))" }}
							>
								dev.cgyeo@gmail.com
