...
│
├── rules/               16개 규칙 (a11y, autonomy, components, icons, mdx-content, no-fallback, project-structure, react, review-discipline, seo, shadcn, styling, testing, theme, typescript, workflow)
