...
│
├── rules/               18개 규칙 (a11y, autonomy, comments, components, icons, mdx-content, meta-consistency, no-fallback, project-structure, react, review-discipline, seo, shadcn, styling, testing, theme, typescript, workflow)
