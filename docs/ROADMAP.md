...
**M7 Polish -- 진행 중 (11/15, 73%)**. M0~M6 전 마일스톤 완료. M7 자율 영역(M7-06~08, M7-13~15) + E2E 인프라(M7-01~05) 완료. 한글 slug는 2026 best practice 리서치 후 **영역별 분리** 정책 채택 — 포스트 영문 강제 / 태그·시리즈 한글 허용 + 공백 hyphen 정규화. Production 배포(M7-09~12)는 별도 PR로 분리 합의.
